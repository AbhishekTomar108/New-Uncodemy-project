      ...
      <div className="content-body">
        <div className="container-fluid">
          ...
          <div className='message-form'>
              ...
              {student &&  <select className="custom-select mr-sm-2" required name='batch' onChange={e=>setSenderId(e.target.value)} >
                  <option disabled selected>Choose...</option>

                  <option value={adminId}>Admin</option>
                  <option value={student.TrainerID}>{student.TrainerName}</option>                  
                  <option value={student.CounselorID}>{student.Counselor}</option>                  
                </select>}
              </div>             
