...
const StudentState = (props) => {
  ...
  const getStudentreceivemessage = async (id) => {
    ...
    const messageRes = await fetch(`http://localhost:8000/Studentreceivemessage/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
